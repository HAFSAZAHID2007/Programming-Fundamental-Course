...
main()
{
    ...
    // data structures
    string nameArray[TOTAL_STUDENTS] = {"zanni", "ammar", "sara", "ahmad", "zain", "nida", "tariq"};
    int ageArray[TOTAL_STUDENTS] = {17, 20, 21, 22, 20, 23, 19};
    float matricArray[TOTAL_STUDENTS] = {909, 890, 940, 960, 880, 910, 995};
    float interArray[TOTAL_STUDENTS] = {1000, 850, 900, 870, 820, 840, 950};
                ...
                if (username == "admin" && password == "123")
                {
                    ...
                    while (true)
                    {
                        ...
                        if (adminoption == "1")
                        {
                            ...
                            for (int i = 0; i < index; i = i + 1)
                                if (nameArray[i] != "")
                                {
                                    ...
                                    cout << nameArray[i] << "\t" << ageArray[i] << "\t" << matricArray[i] << "\t" << interArray[i] << "\t" << ecatArray[i] << "\t"
                                         << pref1Array[i] << "\t" << pref2Array[i] << "\t" << pref3Array[i] << endl;
                                }
                        }
                        else if (adminoption == "2")
                        {
                            ...
                            {
                                cout << "Name\tAge\tMatric\tFSC\tEcat\tP1\tP2\tP3" << endl;
                                cout << nameArray[foundindex] << "\t" << ageArray[foundindex] << "\t" << matricArray[foundindex] << "\t" << interArray[foundindex] << "\t" << ecatArray[foundindex] << "\t"
                                     << pref1Array[foundindex] << "\t" << pref2Array[foundindex] << "\t" << pref3Array[foundindex] << endl;
                            }
                        }
                        else if (adminoption == "3")
                        {
                            ...
                            if (found == true)
                            {
                                ...
                                cout << "Enter your 1st prf :";
                                string pref1;
                                cin >> pref1;
                                cout << "Enter your 2nd prf :";
                                string pref2;
                                cin >> pref2;
                                cout << "Enter your 3rd  prf :";
                                string pref3;
                                cin >> pref3;
